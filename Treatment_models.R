...
#Lisa Pilkinton
#11/02/2026- Control vs OTC, edits to include the full range and keep in EcMAM:Sever, 16/2/26
...
#TREAT_MODEL_1 <- brm( #I use bf() to set up several formula
  # the cover model
...
#  threads = threading(4), # hom many core per core (confusing I know) to speed up even more, use less core that parallel::detectCores()
 ...
 # file = "TREAT_MODEL_1"   # <-- autosaves every few minutes
#)
